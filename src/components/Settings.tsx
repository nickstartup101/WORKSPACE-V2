...
const TextLogoPreview = ({ dark = false, name = "La Dolce" }: { dark?: boolean, name?: string }) => (
  <div className={`flex flex-col items-center text-center gap-2 group`}>
    <h1 className={`text-3xl font-alice tracking-tight leading-none ${dark ? 'text-white' : 'text-[#1E1B4B] dark:text-white'}`}>
      {name}
    </h1>
    
    <div className="flex items-center justify-center gap-2 w-full">
      <div className={`h-[0.5px] flex-1 min-w-[8px] opacity-20 ${dark ? 'bg-white' : 'bg-[#1E1B4B]'}`}></div>
      <span className={`text-[7px] font-sans font-black uppercase tracking-[0.4em] ${dark ? 'text-white/60' : 'text-[#1E1B4B]/60 dark:text-white/40'}`}>
        Workspace
      </span>
      <div className={`h-[0.5px] flex-1 min-w-[8px] opacity-20 ${dark ? 'bg-white' : 'bg-[#1E1B4B]'}`}></div>
    </div>
    
    <div className={`text-[6px] font-sans font-bold uppercase tracking-[0.6em] opacity-30 mt-0.5 ${dark ? 'text-white' : 'text-[#1E1B4B] dark:text-white'}`}>
       estd 2026
    </div>
  </div>
);
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-12 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col justify-center items-center p-10 bg-[#1E1B4B] rounded-[2.5rem] shadow-2xl relative overflow-hidden group border-none">
        ...
        <div className="glass-card p-10 space-y-10">
          <div className="flex items-center justify-between border-b dark:border-white/10 pb-6">
            ...
            <button 
              ...
              className={`w-16 h-10 rounded-full p-1.5 transition-all duration-500 ${isDarkMode ? 'bg-[#1E1B4B]' : 'bg-slate-200'}`}
            >
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <button 
                ...
                disabled={saveLoading}
                className="w-full py-4 bg-[#1E1B4B] text-white rounded-2xl font-bold uppercase tracking-widest text-[11px]"
              >
            ...
            <div className="p-5 bg-blue-50 dark:bg-blue-900/10 rounded-2xl border border-blue-100 dark:border-blue-900/20">
               <p className="text-[10px] text-[#1E1B4B] dark:text-blue-300 italic leading-relaxed">
      ...
      <div className="glass-card p-10 space-y-10 border border-slate-100 dark:border-white/10 dark:bg-white/5 shadow-2xl rounded-[2.5rem]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="p-6 bg-slate-50 dark:bg-white/5 rounded-3xl border border-slate-100 dark:border-white/10 space-y-4 flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <div className="space-y-1.5 p-3 rounded-2xl bg-[#1E1B4B]/5 dark:bg-white/5 border border-slate-200/50 dark:border-white/5">
        ...
        <div className="p-5 bg-[#1E1B4B]/5 dark:bg-white/5 rounded-2xl border border-[#1E1B4B]/10">
              ...
              <div className="p-6 bg-white dark:bg-slate-800 rounded-3xl shadow-sm border border-slate-100 dark:border-white/5">
                ...
                <div className="space-y-4">
                  ...
                  <button 
                    ...
                    disabled={saveLoading}
                    className="w-full h-12 bg-[#1E1B4B] text-white rounded-xl font-black uppercase tracking-widest text-[10px]"
                  >
                    UPDATE MASTER PIN
                  </button>
                </div>
