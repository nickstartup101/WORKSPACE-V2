...
export default function Inventory() {
  ...
  return (
    <div className="space-y-6">
      {/* Top Banner section */}
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 p-6 bg-white dark:bg-[#2D2A6E] rounded-2xl border border-[#1E1B4B]/10 dark:border-white/5 shadow-sm">
        <div className="space-y-1">
          <div className="flex items-center gap-2 flex-wrap">
            <span className="p-1.5 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 rounded-lg">
              <Package className="w-5 h-5" />
            </span>
            <h1 className="text-2xl font-bold tracking-tight text-[#1E1B4B] dark:text-white">
        ...
        <div className="p-4 bg-gradient-to-tr from-[#1E1B4B]/5 to-emerald-500/5 dark:from-[#1E1B4B] dark:to-emerald-500/10 border border-[#1E1B4B]/15 dark:border-white/10 rounded-xl flex items-center gap-4">
          <div className="p-3 bg-emerald-500 text-white rounded-lg shadow-md shadow-emerald-500/20">
            <TrendingUp className="w-5 h-5" />
          </div>
          <div>
            <p className="text-[10px] uppercase font-black tracking-widest text-[#1E1B4B]/60 dark:text-white/60">
              {i18n.language === 'la' ? 'ມູນຄ່າສາງຄົງເຫຼືອໂດຍປະມານ' : 'Estimated Remaining Asset Value'}
            </p>
            <h2 className="text-2xl font-black text-[#1E1B4B] dark:text-emerald-400">
      ...
      <div className="mt-4">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 gap-3 text-slate-500 dark:text-white">
            <RefreshCw className="w-8 h-8 animate-spin text-[#1E1B4B] dark:text-white" />
          ...
          <AnimatePresence mode="wait">
            ...
            {subTab === 'sales' && (
              ...
              >
                ...
                <div className="lg:col-span-2 space-y-6">
                  <div className="bg-white dark:bg-[#2D2A6E] p-6 rounded-2xl border border-slate-200 dark:border-white/5 shadow-sm space-y-6">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 justify-between border-b border-slate-100 dark:border-white/10 pb-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          className="px-3 py-1.5 text-xs font-bold rounded-lg border border-slate-300 dark:border-white/10 bg-slate-50 dark:bg-[#1E1B4B] text-[#1E1B4B] dark:text-white focus:outline-none"
                        />
                      </div>
                    </div>
                    ...
                    {recipes.length === 0 ? (
                      <div className="py-12 text-center space-y-3">
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-[#1E1B4B] dark:bg-sky-600 text-white rounded-lg text-xs font-bold shadow-sm"
                        >
                      ...
                      <div className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {recipesWithCalculatedCosts.map((rec) => (
                            ...
                            >
                              <div className="space-y-1">
                                <h4 className="text-sm font-bold text-[#1E1B4B] dark:text-white">{rec.menuName}</h4>
                                <div className="flex items-center gap-2">
                              ...
                              <div className="flex items-center gap-2">
                                <button
                                  ...
                                  className="w-8 h-8 flex items-center justify-center bg-slate-200 hover:bg-slate-300 dark:bg-white/10 dark:hover:bg-white/20 text-[#1E1B4B] dark:text-white rounded-lg font-bold text-base select-none"
                                >
                                  -
                                </button>
                                <input
                                  ...
                                  className="w-14 py-1.5 font-bold text-center border border-slate-300 dark:border-white/10 rounded-lg dark:bg-[#1E1B4B] text-sm text-[#1E1B4B] dark:text-white bg-white"
                                />
                                <button
                                  onClick={() => setQuantitiesSold(prev => ({
                                    ...prev,
                        ...
                        <div className="flex justify-end gap-3 pt-4 border-t border-slate-100 dark:border-white/10">
                          ...
                          <button
                            ...
                            className="px-6 py-2 bg-[#1E1B4B] dark:bg-emerald-600 hover:bg-[#0c408c] dark:hover:bg-emerald-700 text-white font-black text-xs uppercase tracking-widest rounded-xl shadow-lg shadow-emerald-500/10 flex items-center gap-2"
                          >
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white dark:bg-[#2D2A6E] p-6 rounded-2xl border border-slate-200 dark:border-white/5 shadow-sm space-y-4">
                    <div className="flex items-center gap-2 pb-2 border-b border-slate-100 dark:border-white/10">
                      <UploadCloud className="w-5 h-5 text-[#1E1B4B] dark:text-sky-400" />
                    ...
                    <div className="space-y-3 pt-2">
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 text-xs border border-slate-250 dark:border-white/10 rounded-lg dark:bg-[#1E1B4B] text-slate-800 dark:text-white"
                        />
                      </div>
                      <button
                        onClick={handleLoyverseSync}
                        disabled={isSyncingLoyverse || recipes.length === 0}
                        className="w-full py-2.5 bg-[#1E1B4B] dark:bg-[#0c408c] text-white font-black text-xs uppercase tracking-widest rounded-xl hover:opacity-95 flex items-center justify-center gap-2"
                      >
                      ...
                      <div className="space-y-2.5">
                        {topSellingRecipes.map((item, idx) => (
                          <div key={item.id} className="flex items-center justify-between text-xs">
                            ...
                            <span className="font-black text-[#1E1B4B] dark:text-emerald-400">
            ...
            {subTab === 'recipes' && (
              ...
              >
                {/* Control elements */}
                <div className="flex justify-between items-center bg-white dark:bg-[#2D2A6E] p-4 rounded-xl border border-slate-200 dark:border-white/5 flex-col md:flex-row gap-4">
                  <div>
                    <h3 className="text-sm font-bold text-[#1E1B4B] dark:text-white">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {recipesWithCalculatedCosts.map((recipe) => (
                    <div 
                      key={recipe.id}
                      className="bg-white dark:bg-[#2D2A6E] rounded-2xl border border-slate-200 dark:border-white/5 shadow-sm p-6 space-y-4 flex flex-col justify-between"
                    >
                      <div className="space-y-3">
                        <div className="flex justify-between items-start gap-3">
                          <h4 className="text-base font-black text-[#1E1B4B] dark:text-white leading-tight">
                            {recipe.menuName}
                          </h4>
                  ...
                  {recipesWithCalculatedCosts.length === 0 && (
                    <div className="col-span-full py-20 text-center bg-white dark:bg-[#2D2A6E] rounded-2xl border border-dashed border-slate-300 dark:border-white/10 flex flex-col items-center justify-center gap-2">
            ...
            {subTab === 'balances' && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -10 }}
                className="bg-white dark:bg-[#2D2A6E] rounded-2xl border border-slate-200 dark:border-white/5 shadow-sm overflow-hidden"
              >
                            ...
                            <td className="p-4 text-center">
                              {refutingId === item.id ? (
                                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4">
                                  <div className="bg-white dark:bg-[#2D2A6E] p-6 rounded-2xl border border-slate-200 dark:border-white/10 w-full max-w-sm space-y-4 shadow-xl">
                                    ...
                                    <div className="space-y-3">
                                      <div>
                                        ...
                                        <input
                                          ...
                                          className="w-full px-3 py-2 text-xs border border-slate-300 dark:border-white/10 rounded-lg dark:bg-[#1E1B4B] text-slate-800 dark:text-white"
                                        />
                                      </div>
                                      <div>
        ...
        {isRecipeModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4">
            <motion.div
              ...
              className="bg-white dark:bg-[#2D2A6E] rounded-2xl border border-slate-200 dark:border-white/10 w-full max-w-xl shadow-xl overflow-hidden"
            >
              <div className="p-6 border-b border-slate-100 dark:border-white/5 flex justify-between items-center">
                <h3 className="text-base font-bold text-[#1E1B4B] dark:text-white flex items-center gap-2">
                  <BookOpen className="w-5 h-5 text-emerald-500" />
                  <span>{editingRecipe ? 'Edit Drink Recipe' : 'Configure New Drink Recipe'}</span>
                </h3>
                <button
                  onClick={() => setIsRecipeModalOpen(false)}
                  className="p-1 px-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-white/10 text-[#1E1B4B] dark:text-white rounded-lg select-none font-bold text-xs"
                >
                  ✕
                </button>
              </div>
                            ...
                            <div className="flex justify-between items-start gap-3">
                              <div className="flex-1">
                                ...
                                <select
                                  ...
                                  className="w-full mt-1 px-3 py-1.5 text-xs font-semibold border border-slate-200 dark:border-white/10 rounded-lg dark:bg-[#1E1B4B] text-slate-800 dark:text-white bg-white focus:outline-none focus:ring-1 focus:ring-sky-500/30"
                                >
                                  {products.map(p => (
                            ...
                            <div className="grid grid-cols-3 gap-3">
                              <div>
                                ...
                                <input
                                  ...
                                  className="w-full mt-1.5 px-3 py-1.5 text-xs font-bold border border-slate-200 dark:border-white/10 rounded-lg dark:bg-[#1E1B4B] text-slate-800 dark:text-white bg-white focus:outline-none focus:ring-1 focus:ring-sky-500/30"
                                />
                                ...
                                {(() => {
                                  ...
                                  return (
                                    <select
                                      ...
                                      className="w-full mt-1.5 px-3 py-1.5 text-xs font-bold border border-slate-200 dark:border-white/10 rounded-lg dark:bg-[#1E1B4B] text-slate-800 dark:text-white bg-white focus:outline-none focus:ring-1 focus:ring-sky-500/30 cursor-pointer"
                                    >
                                      {optionsList.map(u => (
        ...
        {isCsvModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4">
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
              exit={{ opacity: 0, scale: 0.95 }}
              className="bg-white dark:bg-[#2D2A6E] rounded-2xl border border-slate-200 dark:border-white/10 w-full max-w-2xl shadow-xl overflow-hidden"
            >
              <div className="p-6 border-b border-slate-100 dark:border-white/5 flex justify-between items-center">
                <h3 className="text-base font-bold text-[#1E1B4B] dark:text-white flex items-center gap-2">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1.5 p-3 rounded-xl bg-slate-100/60 dark:bg-slate-900 border border-slate-200/50 dark:border-white/5">
                      ...
                      <select
                        ...
                        className="bg-white dark:bg-[#1E1B4B] border border-slate-200 dark:border-white/15 text-xs px-2.5 py-1 rounded-lg text-[#1E1B4B] dark:text-white font-bold max-w-xs focus:ring-1 focus:ring-sky-500 outline-hidden"
                      >
                    ...
                    <div className="bg-slate-50 dark:bg-slate-900/40 p-4 rounded-xl border border-slate-100 dark:border-white/5 space-y-2.5 text-xs">
                      <h4 className="font-bold text-[#1E1B4B] dark:text-sky-400 flex items-center gap-1.5">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1.5 p-3 rounded-xl bg-slate-100/60 dark:bg-slate-900 border border-slate-200/50 dark:border-white/5 text-xs">
                      <div className="flex flex-col">
                        <span className="font-bold text-[#1E1B4B] dark:text-sky-400">
                      ...
                      <select
                        value={csvEncoding}
                        onChange={(e) => setCsvEncoding(e.target.value)}
                        className="bg-white dark:bg-[#2D2A6E] border border-slate-200 dark:border-white/15 text-xs px-2.5 py-1 rounded-lg text-[#1E1B4B] dark:text-white font-bold cursor-pointer focus:ring-1 focus:ring-sky-500 timeline-none outline-hidden"
                      >
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      ...
                      <div className="bg-[#1E1B4B]/10 border border-[#1E1B4B]/20 rounded-xl p-3 text-center">
                        <p className="text-[9px] font-black uppercase tracking-wider text-slate-400">Assigned Ings</p>
                        <p className="text-xl font-black text-[#1E1B4B] dark:text-white">
                          ...
                          <tbody className="divide-y divide-slate-100 dark:divide-white/5">
                            {csvPreview.recipes.map((r, itemIdx) => (
                              <tr key={itemIdx} className="hover:bg-slate-50/50 dark:hover:bg-slate-900/10">
                                <td className="p-2.5 font-bold text-[#1E1B4B] dark:text-white">{r.menuName}</td>
                                <td className="p-2.5">
              ...
              <div className="p-6 border-t border-slate-100 dark:border-white/5 flex justify-between items-center bg-slate-50 dark:bg-slate-900/40">
                <button
                  ...
                  className="px-4 py-2 border border-slate-300 dark:border-[#1E1B4B]/20 rounded-xl text-xs font-bold text-slate-500 dark:text-white disabled:opacity-40 cursor-pointer"
                >
