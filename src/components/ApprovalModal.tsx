...
export default function ApprovalModal({ isOpen, onClose, onApprove, actionType, actionData, masterPin }: ApprovalModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-[#1E1B4B]/80 backdrop-blur-sm animate-in fade-in duration-300">
          ...
          {!isRemoteRequested ? (
            <>
              ...
              <button 
                ...
                className="w-full h-12 bg-[#1E1B4B] text-white rounded-xl font-black uppercase tracking-widest hover:scale-[1.02] active:scale-95 transition-all shadow-lg"
              >
                Confirm Action
              </button>
            ...
            <div className="text-center py-8 animate-in zoom-in duration-300">
              ...
              <p className="text-lg font-black text-[#1E1B4B] dark:text-white uppercase tracking-tight">Request Active</p>
