    ...
    return (
      <div className="flex flex-col items-center justify-center py-10 px-6 glass-card bg-red-50 dark:bg-red-900/10 border-red-200 text-center">
        ...
        <div className="mt-8 p-6 bg-white dark:bg-white/5 rounded-3xl border border-red-100 dark:border-red-900/20 text-left w-full max-w-md">
           <p className="text-[10px] font-black uppercase tracking-widest text-[#1E1B4B] dark:text-white mb-4">Required Structure:</p>
  ...
  return (
    <div className="space-y-6">
         ...
         <div className="flex items-center gap-3">
            ...
            <div>
               <div className="flex items-center gap-2">
                 <h2 className="text-sm font-black uppercase tracking-widest text-[#1E1B4B] dark:text-white">Back Office Intelligence</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
        <div className="md:col-span-2 glass-card p-4 sm:p-6 bg-white dark:bg-white/5 border border-slate-100 dark:border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 relative overflow-hidden group">
          ...
          <div className="flex items-center gap-4 relative z-10 font-sans">
            ...
            <div>
              <h3 className="text-xs font-black uppercase text-[#1E1B4B] dark:text-white tracking-wider leading-none mb-2 select-none">
                   ...
                   {[...stockHealth, ...stockHealth, ...stockHealth].map((item, idx) => (
                      <div key={`${item.name}-${idx}`} className="space-y-2 group p-1">
                        <div className="flex justify-between items-end">
                          <div>
                            <p className="text-[10px] font-black uppercase text-[#1E1B4B] dark:text-white tracking-widest">{item.name}</p>
                          ...
                          <div className="text-right">
                            <p className="text-sm font-black text-[#1E1B4B] dark:text-white tracking-tighter leading-none">{item.current}</p>
            ...
            <div className="flex-1">
               <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={inOutData}>
                     ...
                     <Area type="monotone" dataKey="out" stroke="#1E1B4B" fill="url(#colorOut)" strokeWidth={3} />
                  </AreaChart>
               </ResponsiveContainer>
            </div>
         </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
         ...
         <div className="high-density-card bg-white dark:bg-[#1E1B4B] border-2 border-primary/20 flex flex-col justify-center items-center text-center p-6 bg-radial-gradient(from 50% 50%, circle, #fff, #f9fafb)">
            ...
            <h4 className="text-[11px] font-black uppercase tracking-widest text-[#1E1B4B] dark:text-white">Replenishment Logic</h4>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1 glass-card bg-white dark:bg-[#1E1B4B] text-slate-800 dark:text-white flex flex-col border-none shadow-2xl p-8 relative overflow-hidden group">
...
function MatrixModal({ title, onClose, children }: any) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#1E1B4B]/80 backdrop-blur-md animate-in fade-in duration-300">
      <div className="bg-white dark:bg-[#0a0a0a] w-full max-w-4xl max-h-[90vh] rounded-[2rem] border border-white/20 shadow-2xl overflow-hidden flex flex-col scale-in animate-in zoom-in-95 duration-300">
        <div className="p-6 border-b border-slate-100 dark:border-white/5 flex justify-between items-center bg-slate-50/50 dark:bg-white/5">
           <div>
              <h3 className="text-sm font-black uppercase tracking-[0.2em] text-[#1E1B4B] dark:text-white">{title}</h3>
