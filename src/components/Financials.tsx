...
export default function Financials({ appConfig, selectedBranch }: { appConfig: any, selectedBranch?: string }) {
  ...
  const handleGeneratePDFStatement = async () => {
    ...
    try {
      ...
      doc.setFont('Helvetica', 'bold');
      doc.setFontSize(18);
      doc.setTextColor(30, 27, 75); // Deep Brand Blue (#1E1B4B)
      doc.text('LA DOLCE CAFE & CO-WORKING', 14, 20);
    ...
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
      ...
      {showMonthlySummaryModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-primary/20 backdrop-blur-sm overflow-y-auto animate-in fade-in duration-300">
          <div className="bg-white dark:bg-[#2D2A6E] max-w-2xl w-full p-8 rounded-[2rem] border border-slate-200 dark:border-white/10 shadow-2xl space-y-6 text-slate-800 dark:text-white max-h-[90vh] overflow-y-auto scrollbar-hide">
            ...
            <div className="flex justify-between items-start border-b dark:border-white/10 pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-black uppercase tracking-widest text-[#1E1B4B] dark:text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-between p-4 bg-slate-50 dark:bg-black/20 rounded-2xl border border-slate-100 dark:border-white/5">
              ...
              <input 
                ...
                className="w-full sm:w-auto text-xs bg-white dark:bg-[#1E1B4B] border border-slate-200 dark:border-white/10 rounded-xl p-2.5 font-bold outline-none text-slate-800 dark:text-white text-center shadow-sm"
              />
            </div>
            ...
            {loadingMonthlySummary ? (
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <h4 className="text-xs font-black uppercase tracking-widest text-[#1E1B4B] dark:text-sky-300 flex items-center gap-2">
                        ...
                        className={`p-4 rounded-2xl border flex flex-col gap-2 transition-all ${
                          r.level === 'warning' 
                            ...
                            : r.level === 'success'
                              ...
                              : 'bg-[#1E1B4B]/5 border-slate-100 dark:bg-white/5 dark:border-white/10'
                        }`}
                      >
      ...
      {showStatementModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-primary/20 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="bg-white dark:bg-[#2D2A6E] max-w-md w-full p-6 rounded-2xl border border-slate-200 dark:border-white/10 shadow-2xl space-y-6 text-slate-800 dark:text-white">
            <div className="flex flex-col items-center text-center">
              <div className="w-12 h-12 bg-indigo-500/10 rounded-full flex items-center justify-center mb-3">
                <FileText className="w-6 h-6 text-indigo-500" />
              </div>
              <h3 className="text-lg font-black uppercase tracking-tight text-[#1E1B4B] dark:text-white">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs bg-slate-50 dark:bg-[#1E1B4B] border border-slate-200 dark:border-white/10 rounded-xl p-2.5 text-slate-700 dark:text-white focus:outline-none"
                />
              </div>
              ...
              <div className="p-3.5 bg-slate-50 dark:bg-[#1E1B4B]/30 rounded-xl border border-slate-150 dark:border-white/5 space-y-1">
                <p className="text-[10px] font-black uppercase text-slate-404 tracking-wider">
                  {i18n.language === 'la' ? 'ສະຖານທີ່ / ສາຂາ' : 'Reporting Branch'}
                </p>
                <p className="text-xs font-bold text-[#1E1B4B] dark:text-indigo-300">
                ...
                {splitSourceMode && (
                  <div className="grid grid-cols-2 gap-2.5 pt-2 border-t border-slate-200/50 dark:border-white/5 animate-in slide-in-from-top-1 duration-200">
                    <div>
                      ...
                      <input 
                        type="text"
                        className="crystal-input !h-[38px] !text-xs font-bold font-mono text-[#1E1B4B] dark:text-emerald-400"
                        placeholder="0"
                    ...
                    <div>
                      ...
                      <div className="crystal-input !h-[38px] flex items-center justify-center font-bold font-mono text-[11px] text-[#1E1B4B] dark:text-blue-400 bg-slate-100/50 dark:bg-black/30 select-none">
                    ...
                    {!alreadyImported && (
                      <div className="mt-3 pt-3 border-t border-slate-200/50 dark:border-white/5 flex items-center justify-between gap-3">
                        ...
                        <button 
                          ...
                          className="flex-1 h-7 bg-primary hover:bg-[#4F46E5] text-white flex items-center justify-center gap-1.5 text-[9px] font-black uppercase tracking-wider rounded-lg transition-all active:scale-[0.98] cursor-pointer"
                        >
      ...
      <div className="xl:col-span-2 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <motion.div 
            ...
            className="md:col-span-2 group relative overflow-hidden rounded-[2rem] border border-primary/10 bg-white dark:bg-[#1E1B4B] p-8 shadow-2xl transition-all duration-500 hover:shadow-primary/20"
          >
            ...
            <div className="relative z-10 flex flex-col justify-between h-full">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h2 className="text-5xl font-black tracking-tighter text-[#1E1B4B] dark:text-white lg:text-6xl">
          ...
          <div className="flex flex-col gap-4 md:col-span-1">
            ...
            >
              <div className="relative z-10 flex flex-col justify-between h-full">
                <div className="flex items-center justify-between mb-4">
                  <p className="text-[9px] font-black uppercase tracking-wider text-[#1E1B4B]/60 dark:text-blue-200/40">{t('cash_in_hand')}</p>
                  <div className="rounded-xl bg-[#1E1B4B]/5 p-2 dark:bg-blue-400/10">
                    <ArrowUpCircle className="h-4 w-4 text-[#1E1B4B] dark:text-blue-400" />
                  </div>
                </div>
                <h3 className="text-2xl font-bold tracking-tighter text-[#1E1B4B] dark:text-white italic">
            ...
            >
              <div className="relative z-10 flex flex-col justify-between h-full">
                <div className="flex items-center justify-between mb-4">
                  <p className="text-[9px] font-black uppercase tracking-wider text-[#1E1B4B]/60 dark:text-blue-200/40">{t('bank_account')}</p>
                  <div className="rounded-xl bg-[#1E1B4B]/5 p-2 dark:bg-blue-400/10">
                    <Landmark className="h-4 w-4 text-[#1E1B4B] dark:text-blue-400" />
                  </div>
                </div>
                <h3 className="text-2xl font-bold tracking-tighter text-[#1E1B4B] dark:text-white italic">
  ...
  return (
    <div className="group flex items-center gap-4 rounded-[1.5rem] border border-slate-100 bg-white p-4 transition-all duration-500 hover:border-primary/20 hover:shadow-xl dark:border-white/5 dark:bg-white/5">
      ...
      <div>
        ...
        <p className="text-base font-bold tracking-tight text-[#1E1B4B] dark:text-white">
