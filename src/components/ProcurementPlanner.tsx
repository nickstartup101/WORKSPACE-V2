      ...
      <div className="flex bg-slate-100 dark:bg-slate-800/40 p-1 rounded-2xl border border-slate-200/50 dark:border-white/5 w-full max-w-sm sm:max-w-md">
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl text-xs font-black transition-all cursor-pointer ${
            plannerTab === 'auto'
              ? 'bg-white dark:bg-slate-900 text-[#1E1B4B] dark:text-emerald-400 shadow-sm'
      ...
      {plannerTab === 'auto' ? (
        <>
          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-slate-50/50 dark:bg-[#1E1B4B]/15 p-4 rounded-2xl border border-slate-100 dark:border-white/5 shadow-sm col-span-full">
                      ...
                      <div className="pt-4 mt-4 border-t border-slate-50 dark:border-white/5 flex items-center justify-between gap-1">
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <button
                            ...
                            className="px-4 py-2 bg-[#1E1B4B] hover:bg-[#2D2A6E] text-white text-[10px] uppercase tracking-widest font-black rounded-xl duration-200 flex items-center gap-1.5 cursor-pointer"
                          >
                            <Printer className="w-3.5 h-3.5" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-between sm:items-center">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="pl-8 pr-4 py-1.5 rounded-xl border border-slate-200 dark:border-white/10 dark:bg-[#1E1B4B] text-xs font-semibold text-slate-800 dark:text-white bg-white w-full sm:w-56"
                />
              </div>
            </div>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="space-y-0.5 truncate flex-1">
                        <div className="flex items-center gap-1.5 flex-wrap">
                          ...
                          <h4 className="font-extrabold text-[#1E1B4B] dark:text-sky-400 capitalize text-xs truncate leading-tight">{p.name}</h4>
                          {isExhausted && (
        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-7 bg-white dark:bg-slate-900 border border-slate-100 dark:border-white/5 rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-xl space-y-4">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="pl-8 pr-4 py-1.5 rounded-xl border border-slate-200 dark:border-white/10 dark:bg-[#1E1B4B] text-xs font-semibold text-slate-800 dark:text-white bg-white w-full"
                />
              </div>
                        ...
                        <div className="flex items-center justify-between gap-4 w-full">
                          ...
                          <div className="flex items-center gap-1 shrink-0 bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-white/5 rounded-xl p-0.5">
                            {qtyInBasket > 0 ? (
                              ...
                              <button
                                onClick={() => updateBasketQty(p.id, 1)}
                                className="px-3 py-1 bg-[#1E1B4B] hover:bg-[#2D2A6E] text-white text-[10px] uppercase font-black tracking-widest rounded-lg flex items-center gap-1 h-7 duration-150 cursor-pointer"
                              >
                                <span>+ Add</span>
                              </button>
                            )}
                              ...
                              <div className="flex items-center gap-1.5 text-[9.5px]">
                                {currentUnit === 'box' ? (
                                  <div className="flex items-center gap-1 text-slate-500 dark:text-slate-350 animate-in fade-in duration-100">
                                    <span className="font-bold text-[8.5px] uppercase text-[#1E1B4B] dark:text-sky-300">📦 1 Box =</span>
                                    <input
                                      type="number"
                                      min="1"
                                      ...
                                      className="w-10 h-5 text-center border border-slate-200 dark:border-white/10 dark:bg-[#2D2A6E] rounded-md font-bold text-xs p-0 text-slate-800 dark:text-white"
            ...
            <div className="lg:col-span-5 space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-slate-50/50 dark:bg-[#1E1B4B]/15 p-4 rounded-2xl border border-slate-100 dark:border-white/5 shadow-sm">
                    ...
                    return (
                      ...
                      >
                        <div className="space-y-4">
                          ...
                          <div className="space-y-2 max-h-[180px] overflow-y-auto">
                            {bill.items.map((it, i) => (
                              <div key={i} className="flex items-center justify-between p-2 bg-slate-50/50 dark:bg-[#1E1B4B]/10 rounded-xl text-xs">
                                <div className="space-y-0.5 pr-2 truncate">
                                  <p className="font-bold text-slate-800 dark:text-white truncate">
                                    {it.productName}
                                  </p>
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  ...
                  <div className="bg-white/5 p-3 rounded-2xl border border-white/5">
                    ...
                    <select 
                      ...
                      className="w-full mt-1.5 bg-[#1E1B4B] text-white border border-white/10 rounded-lg p-1 text-xs font-bold font-mono outline-none"
                    >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5 mt-1">
                    <div>
                      ...
                      <input 
                        ...
                        className="w-full bg-[#1E1B4B] text-white border border-white/10 rounded-lg p-1.5 text-[10px] font-mono outline-none focus:border-emerald-500 transition-colors"
                    ...
                    {selectedBill.isCombined ? (
                      selectedBill.originalGroups.map((group: any, gIndex: number) => (
                        <div key={gIndex} className="space-y-1">
                          <p className="text-[10px] font-black text-[#1E1B4B] border-b border-dashed border-slate-300 pb-0.5 uppercase tracking-wide">
                  ...
                  <button
                    ...
                    className={`w-full py-2.5 px-4 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer h-11 ${
                      loggedExpenseBills.includes(selectedBill.supplier)
                        ...
                        : 'bg-gradient-to-r from-[#4F46E5] to-[#4f46e5] hover:from-blue-600 hover:to-indigo-600 text-white shadow-lg shadow-indigo-500/15 active:scale-[0.99]'
                    }`}
                  >
                    {loggedExpenseBills.includes(selectedBill.supplier) ? (
                      <>
